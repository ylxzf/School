...
class WeatherStation {
    ...
    public WeatherStation(String id, double meanTemperature) {
        this.id = id;
        this.meanTemperature = (float) meanTemperature;
    }
    ...
    public String toString() {
        return "WeatherStation [id=" + id + ", meanTemperature=" + meanTemperature + "]";
    }

    public float actualTemperature() {
        return meanTemperature + 2 * (float) rnd.nextGaussian();
    }

    public String getMesurement() {
        return String.format(Locale.ENGLISH,
                "%s;%3.1", this.id, this.actualTemperature());
    }
